module.exports = {
    ...
    startmedia: {
        ...
        next: [
            ['video', 'Ich mache das Radio an'],
            ['restmusic', 'Ich öffne Spotify', 'accounts.spotify.enable', true, 'write'],
            ['restmusic', 'Ich gehe zu youtube', 'accounts.google.enable', true, 'write'],
            ['restmusic', 'Hey, Alexa...', 'accounts.amazon.enable', true, 'write']]
    },
    ...
    random_spam: {
        text: 'I am a Nigerian prince and need your help to save 9 mill $.If you can give me your bank account I will give you 30 %.Please contact me so we can start our business.',
        next: [
            ['posiive', 'Wow, das klingt gut!'],
            ['negative', 'Weg damit']
        ]
    },

    random_ads: {
        text: '5 heiße Singles in deiner Nähe, von denen deine Ärzte nicht wissen wollen, dass du sie kennst!',
        next: [
            ['positive', 'Mmmmh mal kennen lernen'],
            ['negative', 'Jaja weg damit...']
        ]
    },

    random_positive: {
        text: 'Warum fällst du auf diesen Spam herein??? Danke für deine Daten, hier ist die Waschmaschine.',
        next: [
    ...
    schufa_startschufa: {
        text: 'Du hast einen Brief bekommen.',
        next: [
            ['daytwo', 'Oh nee, Rundfunkgebühren Gebühren! Zahle ich...später.'],
            ['daytwo', 'G...E....ach weg damit']
        ]
    },

    work_daytwo: {
        text: 'Du gehst wieder zur Arbeit und schaust in deine Mails.',
        next: [
            ['random.spam', 'Oh, ein nigerianischer Prinz'],
            ['phishing', 'Hmm, was ist das denn?']
        ]
    },

    work_phishing: {
        text: 'Das würde doch sehr gut zum Geschenk gestern passen! Woher wissen die das...',
        next: [
            ['work_audio/work_shopping', 'Passt ja super, direkt mitgekauft'],
            ['work_audio/work_shopping', 'Nee, das reicht erstmal']
        ]
    },
    //wenn media_startmedia Spotify oder youtube ist zu work_audio. Bei Alexa zu work_shopping.

    work_audio: {
        text: 'Da die Kollegen zu laut Kuchen essen, brauchst du Musik zur Konzentration. Zurück in der Playlist von gestern siehst du noch ein paar weitere passende Musikvorschläge. Jetzt bist du endgültig abgelenkt und schreibst mit deinem Partner. Mmmh, du hast hier so schöne Bilder von dir...',
        next: [
            ['fired', 'Sharing is caring'],
            ['sick', 'Doch nicht während der Arbeitszeit']
        ]
    },

    //wenn media_startmedia Alexa war zu work_shopping. Bei Spotify oder youtube zu work_audio.
    work_shopping: {
        text: 'Da die Kollegen zu laut Kuchen essen, kannst du dich nicht konzentrieren und du schaust mal bei Amazon vorbei. Oh, hier ist ja das Album von der Band gestern.',
        next: [
            ['enddaytwo', 'Gleich bestellen'],
            ['enddaytwo', 'Brauche ich eigentlich nicht wirklich...']
        ]
    },

    work_enddaytwo: {
        text: 'Auch der heutige Tag war relativ unspektakulär (mhh Spekulatius) und du freust dich aufs Date morgen.',
        next: [
            ['startconcert/sick', 'Yay!'],
            ['startconcert / sick', 'Neudeutsch: Juhu!']
        ]
    },
    ...
    concert_startconcert: {
        text: 'Bei eurem Date siehst du eine Gruppe, die ein Selfie macht.',
        next: [
            ['sick', 'Haha, Deppen'],
            ['drugs', 'Yeaaaah Photobomb!!!']
        ]
    },

    concert_drugs: {
        text: 'Stellt sich heraus, dass auf dem Event nicht nur du dabei warst, sondern auch ein unter Beobachtung stehender Drogendealer. Das SEK durchsucht jetzt deine Wohnung.',
        next: [
            ['nicetry', 'Noch eine Runde?']
        ]
    },
    ...
    schufa_sick: {
        text: 'Weil du spontan starke Zahnschmerzen bekommen hast, gehst du zum Arzt. Dieser stellt fest, dass du auf Grund deiner mangelnden Zahnhygiene eine aufwändige Zahnbehandlung brauchst, die die Kasse nicht übernimmmt.',
        next: [
            ['positive', 'Gabs da nicht so nigerianische Prinzen...?'],
            ['nocredit', 'Schnell ein Kredit?']
        ]
    },

    schufa_nocredit: {
        text: 'Tja, wer seine Rechnungen nicht zahlt hat natürlich auch eine geringe Kreditwürdigkeit. Kein Geld für dich!',
        next: [
            ['nicetry', 'Noch eine Runde?']
        ]
    },
    ...
    work_fired: {
        text: 'Wer hätte geahnt, dass dein Partner alle Bilder in die Cloud synct. Mit den Nacktbildern nimmt dich jetzt erstmal keiner auf der Arbeit ernst, sorry ^^',
        next: ['nicetry', 'Noch eine Runde?']
    },

    fail_nicetry: {
        text: 'Im echten Leben gibt es auch keine zweite Chance für deine Daten.',
        next: [
